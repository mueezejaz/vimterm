...
func TestParseSequence(t *testing.T) {
	...
	tests := []struct {
		...
		{"ctrl+uppercase letter normalizes", "ctrl+D", []Key{NewRune('d', ModCtrl)}, false},
		{"ctrl+shift+letter", "ctrl+shift+D", []Key{NewRune('d', ModCtrl|ModShift)}, false},
		{"alt+uppercase letter", "alt+G", []Key{NewRune('g', ModAlt)}, false},
